...
configure-io4edge_api-dev:
	idf.py -DCAN_L2_IO4EDGE_API_DEV=true -DESP_IO4EDGE_IO4EDGE_API_DEV=true reconfigure
...
configure-io4edge_api-prod:
	idf.py -DCAN_L2_IO4EDGE_API_DEV=false -DESP_IO4EDGE_IO4EDGE_API_DEV=false reconfigure
